...
public class AddRealCustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (RealCustomerLogic.validateAddRealCustomer(name, familyName, fatherName, birthDate, nationalCode)) {
                {
                    realCustomer = RealCustomerLogic.insertRealCustomer(name, familyName, fatherName, birthDate, nationalCode);
                }
            }
